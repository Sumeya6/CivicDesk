...
describe("AnnouncementBoard", () => {
  it("renders active announcements from Redux API flow", async () => {
    axios.get.mockImplementation((url) => url === "/announcements" ? Promise.resolve({ data: { success: true, message: "Announcements retrieved.", data: [{ id: "1", title: "Planned maintenance", content: "Network maintenance tonight.", createdAt: "2026-09-05T00:00:00.000Z" }] } }) : Promise.reject(new Error("unexpected request")));
